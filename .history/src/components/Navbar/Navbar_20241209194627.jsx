...
export default function Navbar() {
  ...
  return (
    <>
      <nav className={`bg-slate-100 border-gray-200 md:dark:bg-gray-800 dark:bg-gray-600 dark:border-gray-700  md:fixed top-0 start-0 end-0 z- shadow-md ${isDarkMode ? 'dark' : ''}`}>
